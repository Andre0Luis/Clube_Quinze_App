...
const formatTierLabel = (tier?: AppointmentTier) => {
  switch (tier) {
    ...
    case "QUINZE_PREMIUM":
      return "Quinze Premium";
    case "QUINZE_STANDARD":
    default:
      return "Quinze Standard";
  }
};
...
export default function ReserveScreen() {
  ...
  const historyAppointments = useMemo(() => {
    ...
    return appointments
      .filter((appointment) => {
        const scheduledTime = new Date(appointment.scheduledAt).getTime();
        const isPast = !Number.isNaN(scheduledTime)
          ? scheduledTime < now
          : false;
  ...
  const handleViewDetails = useCallback(
    (appointmentId: number) => {
      router.push(`/appointments/${String(appointmentId)}`);
    },
    [router],
  );
                ...
                <View style={styles.cardHeader}>
                  ...
                  <View style={styles.cardHeaderTexts}>
                    ...
                    <Text style={styles.cardDescription}>
                      {formatTierLabel(appointment.appointmentTier)}
                    </Text>
                  </View>
                  <View
                    style={[
                  ...
                  >
                    <Text
                      style={[styles.statusText, { color: statusMeta.text }]}
                    >
                      {statusMeta.label}
                    </Text>
                  </View>
