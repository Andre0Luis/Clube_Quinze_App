...
const myCommunities = [
	...
	},
	{
		...
		description: "Compartilhe experiencias que elevam sua rotina.",
		members: 289,
		unread: 2,
	},
];
...
const myPosts = [
	{
		...
		content:
			"Voce sabia que segundo o calendario maia, hoje e conhecido como 'um dia fora do tempo'? Aproveite para desacelerar e cuidar de voce.",
		likes: 16,
		comments: 3,
	},
	{
		...
		<SafeAreaView style={styles.safeArea}>
			<ScrollView contentContainerStyle={styles.content}>
				...
				<View style={styles.sectionHeader}>
					<Text style={styles.sectionTitle}>Ultimas interacoes</Text>
