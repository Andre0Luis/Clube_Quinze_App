      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <View style={styles.logoWrapper}>
            ...
            />
            <View>
              <Text style={styles.greeting}>Ola, Joao</Text>
        ...
        <View style={styles.highlightCard}>
          ...
          <Text style={styles.highlightSubtitle}>Sexta-feira, 17 de junho  15:30</Text>
        ...
        <View style={styles.cardsRow}>
          <View style={[styles.smallCard, styles.socialCard]}>
            <Text style={styles.smallCardTag}>Responsabilidade Social</Text>
            <Text style={styles.smallCardTitle}>Passos Magicos</Text>
            <Text style={styles.smallCardText}>
              Participe das nossas acoes e compartilhe experiencias com nossos alunos.
            </Text>
          </View>

          <View style={[styles.smallCard, styles.productsCard]}>
            <Text style={styles.smallCardTag}>Produtos Quinze</Text>
            <Text style={styles.smallCardTitle}>Autocuidado premium</Text>
            <Text style={styles.smallCardText}>
              Descubra a linha que leva o autocuidado masculino a outro nivel.
            </Text>
          </View>
        </View>
      </ScrollView>
