      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <View style={styles.highlightCard}>
            ...
            <Text style={styles.highlightTitle}>Passos Mágicos</Text>
            <Text style={styles.highlightDescription}>
              Participe de uma das nossas ações sociais, compartilhando experiências com nossos alunos e apoiando novas histórias.
            </Text>
          ...
          >
            ...
            {isLoggingOut && <ActivityIndicator size="small" color={Color.mainGoten} style={styles.logoutSpinner} />}
          </TouchableOpacity>
